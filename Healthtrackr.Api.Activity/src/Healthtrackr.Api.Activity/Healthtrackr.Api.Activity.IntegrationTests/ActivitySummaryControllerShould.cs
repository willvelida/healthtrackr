...
{
    public class ActivitySummaryControllerShould : IClassFixture<WebApplicationFactory<Program>>
    {
        private readonly WebApplicationFactory<Program> _applicationFactory;

        public ActivitySummaryControllerShould(WebApplicationFactory<Program> applicationFactory)
        {
