...
@description('The Principal Id of the Container App that we will grant the role assignment to.')
param containerAppPrincipalId string

var roleDefinitionId = guid('sql-role-definition-', containerAppPrincipalId, cosmosDbAccount.id)
var roleAssignmentId = guid(roleDefinitionId, containerAppPrincipalId, cosmosDbAccount.id)
var roleDefinitionName = 'HealthCheckr Activity API Cosmos DB Metadata Reader Role'
var dataActions = [
